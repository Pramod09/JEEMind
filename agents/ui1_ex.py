...
chat_box_2 = ChatBox(
    use_rich_markdown=True, # use streamlit-markdown
    user_theme="yellow", # see streamlit_markdown.st_markdown for all available themes
    assistant_theme="blue",
)

chat_box_2 = ChatBox(
    use_rich_markdown=True, # use streamlit-markdown
    user_theme="red", # see streamlit_markdown.st_markdown for all available themes
    assistant_theme="blue",
)
chat_box = chat_box_1
